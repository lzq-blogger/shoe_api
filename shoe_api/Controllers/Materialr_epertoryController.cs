...
{
    [RoutePrefix("Materialr_epertory")]

    public class Materialr_epertoryController : ApiController
    {
        ...
        public BaseDataTables YuanLiaokc([FromBody] GetDataTablesMessage obj)
        {
            ...
            //            select q; ;
            var list1 = db.materialr_epertory.ToList();
            //查询数据表总共有多少条记录
            int rows1 = db.materialr_epertory.ToList().Count;
